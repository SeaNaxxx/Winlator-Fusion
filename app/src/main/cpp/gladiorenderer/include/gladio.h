...
#define X11_SERVER_PATH_DEFAULT "/data/data/com.winlator.fusion/files/fusionfs/bionic/tmp/.X11-unix/X0"
#define X11_SERVER_PATH (getenv("X11_SERVER_PATH") ? getenv("X11_SERVER_PATH") : X11_SERVER_PATH_DEFAULT)
