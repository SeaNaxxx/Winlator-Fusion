...
#define VORTEK_SERVER_PATH_DEFAULT "/data/data/com.winlator.fusion/files/fusionfs/glibc/tmp/.vortek/V0"
#define VORTEK_SERVER_PATH (getenv("VORTEK_SERVER_PATH") ? getenv("VORTEK_SERVER_PATH") : VORTEK_SERVER_PATH_DEFAULT)
