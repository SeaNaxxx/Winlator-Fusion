...
public abstract class GraphicsDrivers {
    ...
    public static final String DEFAULT_VULKAN_DRIVER = TURNIP;
    public static final String DEFAULT_OPENGL_DRIVER = GLADIO;
    public static final String DEFAULT_VULKAN_DRIVER_BIONIC = WRAPPER;
    public static final String DEFAULT_OPENGL_DRIVER_BIONIC = GLADIO;
    ...
    public static boolean isVulkanDriver(String identifier) {
        return identifier != null && (identifier.equals(TURNIP) || identifier.equals(VORTEK) || identifier.equals(WRAPPER));
    }
    ...
    public static String[] getItems(String apiName, boolean isBionic) {
        if (apiName.equalsIgnoreCase("VULKAN")) {
            if (isBionic) {
                return new String[]{getName(TURNIP), getName(WRAPPER)};
            } else {
    ...
    public static String getDefaultDriver(Context context) {
        return getDefaultDriver(context, false);
    }

    public static String getDefaultDriver(Context context, boolean isBionic) {
        if (isBionic) {
            return GPUHelper.isAdreno(context) ? GraphicsDrivers.TURNIP+","+GraphicsDrivers.DEFAULT_OPENGL_DRIVER_BIONIC : GraphicsDrivers.WRAPPER+","+GraphicsDrivers.DEFAULT_OPENGL_DRIVER_BIONIC;
        } else {
