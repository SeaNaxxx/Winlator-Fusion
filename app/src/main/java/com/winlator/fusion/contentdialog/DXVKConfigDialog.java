...
import com.winlator.fusion.widget.GPUCardAdapter;
...
public class DXVKConfigDialog extends ContentDialog {
    ...
    public static void setEnvVars(Context context, KeyValueSet config, EnvVars envVars) {
        setEnvVars(context, config, envVars, RootFS.find(context).getRootDir());
    }

    public static void setEnvVars(Context context, KeyValueSet config, EnvVars envVars, File rootDir) {
