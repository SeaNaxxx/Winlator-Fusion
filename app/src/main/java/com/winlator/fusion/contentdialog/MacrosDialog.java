...
/** Simple list-based macros UI for configuring input turbo mode per gamepad button. */
public final class MacrosDialog {
    ...
    public static void show(Activity activity, int slotIndex, WinHandler winHandler) {
        ...
        // Force hint/switch text color for dark mode
        if (dark) {
        ...
        // Bottom-bar copies (in ContentDialog) - IDs may not exist in all layouts
        Button btEnableAllBar  = dialog.findViewById(0);
        Button btDisableAllBar = dialog.findViewById(0);
