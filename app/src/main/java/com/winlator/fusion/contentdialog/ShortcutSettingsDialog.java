...
import com.winlator.fusion.ContainerDetailFragment;
...
public class ShortcutSettingsDialog extends ContentDialog {
    ...
    private void createContentView() {
        ...
        boolean isBionic = shortcut.container.isBionic();
        GraphicsDriverPicker graphicsDriverPicker = new GraphicsDriverPicker(findViewById(R.id.LLGraphicsDriver), selectedGraphicsDriver, oldGraphicsDriverConfig, isBionic);
        ...
        DXWrapperPicker dxwrapperPicker = new DXWrapperPicker(findViewById(R.id.LLDXWrapper), graphicsDriverPicker, selectedDXWrapper, oldDXWrapperConfig, isBionic);
    ...
    private void loadControlsProfileSpinner(Spinner spinner, String selectedValue) {
        ...
        int selectedId = 0;
        try {
            selectedId = Integer.parseInt(selectedValue);
