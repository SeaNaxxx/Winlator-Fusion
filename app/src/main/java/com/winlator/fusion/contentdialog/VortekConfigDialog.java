...
import com.winlator.fusion.widget.MultiSelectionComboBox;
...
public class VortekConfigDialog extends ContentDialog {
    ...
    public VortekConfigDialog(final View anchor) {
        ...
        setOnConfirmCallback(() -> {
            ...
            String vkMaxVersionValue = sVkMaxVersion.getSelectedItem() != null ? sVkMaxVersion.getSelectedItem().toString() : DEFAULT_VK_MAX_VERSION;
            if (vkMaxVersionValue.isEmpty()) vkMaxVersionValue = DEFAULT_VK_MAX_VERSION;
