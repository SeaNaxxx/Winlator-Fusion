...
public class NTSCCombinedEffect extends Effect {
    ...
    protected ScreenMaterial createMaterial() {
        final ShaderMaterial.Uniform frameCountUniform = new ShaderMaterial.Uniform("FrameCount");
        final ShaderMaterial.Uniform textureSizeUniform = new ShaderMaterial.Uniform("TextureSize");
        ...
        return new ScreenMaterial() {
            ...
            public void use() {
                super.use();
                setUniformInt(frameCountUniform, frameCount);
                setUniformVec2(textureSizeUniform, (float)texWidth, (float)texHeight);
            }
        };
    }
