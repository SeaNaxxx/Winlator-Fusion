...
import com.winlator.fusion.inputcontrols.GamepadSlot;
import com.winlator.fusion.inputcontrols.GamepadState;
import com.winlator.fusion.inputcontrols.GamepadVibration;
...
public class GamepadHandler {
    ...
    public void setGyroData(float yaw, float pitch, boolean toLeftStick) {
        this.gyroYaw = yaw;
