...
import com.winlator.fusion.xserver.errors.BadIdChoice;
import com.winlator.fusion.xserver.errors.BadMatch;
import com.winlator.fusion.xserver.errors.BadValue;
import com.winlator.fusion.xserver.errors.XRequestError;
import com.winlator.fusion.xserver.events.ConfigureNotify;
import com.winlator.fusion.xserver.events.ConfigureRequest;
import com.winlator.fusion.xserver.events.DestroyNotify;
import com.winlator.fusion.xserver.events.Event;
import com.winlator.fusion.xserver.events.Expose;
import com.winlator.fusion.xserver.events.MapNotify;
import com.winlator.fusion.xserver.events.MapRequest;
import com.winlator.fusion.xserver.events.ResizeRequest;
import com.winlator.fusion.xserver.events.UnmapNotify;
...
public class WindowManager extends XResourceManager {
    ...
    private void removeAllSubwindowsAndWindow(Window window) {
        ...
        for (int i = onWindowModificationListeners.size()-1; i >= 0; i--) onWindowModificationListeners.get(i).onDestroyWindow(window);
